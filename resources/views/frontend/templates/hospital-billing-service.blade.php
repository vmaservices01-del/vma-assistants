    ...
    <div class="max-w-6xl mx-auto px-6 lg:px-8 w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex flex-col justify-center">
            ...
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.05] tracking-tight text-[#0F172A] mb-6 font-gnarly capitalize">
                Let hospitals focus on patient care<br>
                <span class="text-[#7C3AED]">with Remote Healthcare Team.</span>
            </h1>
...
@php
    $challenges = [
        ...
        [
            ...
            'desc' => 'Whether it is new payer requirements, hospital billing regulations, or software updates, our specialists provide the expertise needed to keep billing operations accurate and compliant.',
        ...
        [
            ...
            'desc' => 'Our hospital billing experts identify underpayments, missed reimbursements, and billing errors, helping recover revenue that might otherwise remain uncollected.',
            'icon' => 'M 12 22 a 10 10 0 1 0 0 -20 a 10 10 0 0 0 0 20 z M 12 6 v 12 M 15 8 H 10 a 2 2 0 0 0 0 4 h 4 a 2 2 0 0 1 0 4 H 9', // Symmetrical Circle Dollar
        ],
        ...
        [
            ...
            'desc' => 'Our billing specialists analyze your hospital revenue cycle, uncover inefficiencies, and provide actionable recommendations to improve collections, reduce denials, and strengthen financial performance.',
