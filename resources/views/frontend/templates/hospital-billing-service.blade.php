    ...
    <div class="max-w-6xl mx-auto px-6 lg:px-8 w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex flex-col justify-center">
            ...
            <div class="inline-flex items-center gap-2 px-4 py-1.5 bg-[#f0fdf4] text-[#059669] rounded-full text-xs font-semibold border border-[#dcfce7] mb-6 w-fit">
                ...
                25+ healthcare organizations partnered with VMA hospital billing team
            </div>
            ...
            <p class="text-slate-500 text-[16px] leading-relaxed mb-8 max-w-lg font-sans">
                VMA handles claims processing, denial management, coding support, and reimbursement optimization so your hospital can focus on delivering quality patient care. Maximize hospital revenue while reducing administrative burden across departments.
            </p>
...
<section class="max-w-6xl mx-auto px-6 py-20 text-center">
    ...
    <div class="inline-flex px-3 py-1 mb-6 text-[11px] font-bold text-primary uppercase tracking-widest bg-indigo-50/50 rounded-full border border-indigo-100">
        HOSPITAL BILLING SOLUTIONS FOR HEALTHCARE TEAMS
    </div>

    <!-- Title & Desc -->
    <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tighter mb-4 capitalize">
        Smart Hospital Billing Support For Healthcare Facilities
    </h2>
    <p class="text-gray-500 mb-10 max-w-lg mx-auto leading-relaxed">
        VMA hospital billing experts streamline claims processing, insurance verification, prior authorizations, and reimbursement workflows to improve operational efficiency and revenue performance across hospital operations.
    </p>

    <!-- Browse Button -->
    <button class="mb-16 border-2 border-gray-200 hover:border-gray-300 px-6 py-3 rounded-xl font-semibold transition-all">
       Explore Hospital Billing Services →
    </button>
        ...
        @php
            $roles = [
                ...
                [
                    ...
                    'desc' => 'Maintains accurate hospital records while supporting compliant clinical workflows.',
                    'url' => '/roles/documentation-specialist',
                    'icon' => 'M 12 2 H 6 a 2 2 0 0 0 -2 2 v 16 a 2 2 0 0 0 2 2 h 12 a 2 2 0 0 0 2 -2 V 8 z M 14 2 v 6 h 6 M 16 13 H 8 M 16 17 H 8 M 10 9 H 8' // Structured document page with text lines
                ],

                [
                    'title' => 'Hospital Coordinator',
                    'desc' => 'Supports scheduling, coordination, and daily hospital administrative tasks remotely.',
                    'url' => '/roles/hospital-coordinator',
                    'icon' => 'M 8 2 v 4 M 16 2 v 4 M 3 10 h 18 M 5 4 h 14 a 2 2 0 0 1 2 2 v 14 a 2 2 0 0 1 -2 2 H 5 a 2 2 0 0 1 -2 -2 V 6 a 2 2 0 0 1 2 -2 z M 9 16 l 2 2 4 -4' // Calendar Scheduler with Checkmark
                ],

                [
                    'title' => 'Medical Scribe',
                    'desc' => 'Records patient visits and updates documentation during virtual or in-person consultations.',
                    'url' => '/roles/medical-scribe',
                    'icon' => 'M 12 20 h 9 M 16.5 3.5 a 2.121 2.121 0 0 1 3 3 L 7 19 l -4 1 l 1 -4 L 16.5 3.5 z' // Pencil writing / Scribing on a sheet
                ],

                [
                    'title' => 'Revenue Analyst',
                    'desc' => 'Manages hospital billing workflows and ensures accurate reimbursement processing.',
                    'url' => '/roles/revenue-analyst',
                ...
                [
                    ...
                    'url' => '/roles/insurance-specialist',
                    'icon' => 'M 21 4 H 3 a 2 2 0 0 0 -2 2 v 12 a 2 2 0 0 0 2 2 h 18 a 2 2 0 0 0 2 -2 V 6 a 2 2 0 0 0 -2 -2 z M 1 10 h 22 M 4 15 h 2 M 8 15 h 4' // Insurance/Eligibility ID Card
                ],
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-16">
            ...
            <p class="text-black text-[14px] md:text-[16px] leading-relaxed max-w-2xl mx-auto font-normal">
               Stop wasting time on software training. VMA 4-week intensive training program provides vetted and certified professionals skilled in hospital documentation workflows and complex medical billing cycles. We hit the ground running so your hospital never misses a beat.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @php
                $ehrList = [
                    ...
                    [
                        'title' => 'CareCloud',
                        'desc' => 'Revenue Cycle Management, Telehealth, Practice Management.',
                        'icon' => 'building',
                    ],
            ...
            @php
                $fees = [
                    ...
                    [
                        ...
                        'included' => true,
                        'icon' => 'M 14 2 H 6 a 2 2 0 0 0 -2 2 v 16 a 2 2 0 0 0 2 2 h 12 a 2 2 0 0 0 2 -2 V 8 z M 14 2 v 6 h 6 M 8 12 h 8 M 8 16 h 5', // Document/Claims Sheet
                    ],
                    ...
                    [
                        ...
                        'included' => true,
                        'icon' => 'M 12 22 s 8 -4 8 -10 V 5 l -8 -3 -8 3 v 7 c 0 6 8 10 8 10 z M 9 11 l 2 2 4 -4', // Shield checkmark
                    ],
...
<section class="max-w-6xl mx-auto px-6 py-12">
    @php
        $customerBenefits = [
            ...
            'Streamlines hospital revenue cycle operations',
    ...
    <div class="relative w-full rounded-[40px] overflow-hidden p-8 md:p-12 lg:p-18 bg-gradient-to-br from-[#0d8276] via-[#115e59] to-[#4c1d95] text-white">
        ...
        <div class="relative z-10">
            ...
            <p class="text-white/70 text-[14px] max-w-3xl leading-relaxed mb-10 font-sans">
               Our Hospital Billing Service account manager isn’t just your billing contact. They serve as the single point of contact for both your hospital and our billing team, a bridge between both sides. When there’s a concern, they already have context from multiple departments and stakeholders. When there’s a discrepancy, they resolve it. When there’s an opportunity, they coordinate and optimize the revenue cycle.
            </p>
...
@php
    $challenges = [
        ...
        [
            'title' => 'Hospital Claim Denials Are Increasing',
            'desc' => 'Our hospital billing specialists investigate the root cause of denials, identify recurring issues, and implement corrective actions to improve first-pass claim acceptance and reimbursement rates.',
            'icon' => 'M 15 2 H 6 a 2 2 0 0 0 -2 2 v 16 a 2 2 0 0 0 2 2 h 12 a 2 2 0 0 0 2 -2 V 7 Z M 14 2 v 4 a 1 1 0 0 0 1 1 h 4 M 12 9 v 4 M 12 17 h 0.01', // Document with Alert Exclamation
        ],
        ...
        [
            'title' => 'Your Hospital Network Is Expanding',
            'desc' => 'As your healthcare facility expands, billing complexity increases. We help manage higher claim volumes, streamline workflows, and ensure your revenue cycle scales efficiently alongside your growth.',
            'icon' => 'M 23 6 H 17 M 23 6 v 6 M 23 6 L 13.5 15.5 L 8.5 10.5 L 1 18', // Trending Up Arrow
        ],

        [
            'title' => 'Administrative Burden Is Growing',
            'desc' => 'We handle payer requirements, hospital billing regulations, and system updates to keep operations accurate, compliant, and efficient.',
            'icon' => 'M 12 2 L 2 7 l 10 5 l 10 -5 Z M 2 17 l 10 5 l 10 -5 M 2 12 l 10 5 l 10 -5', // Stacked layers / Administration files
        ],

        [
            'title' => 'Outstanding Receivables Are Rising',
            'desc' => 'We follow up on aging accounts, appeal denied claims, and accelerate reimbursements to improve hospital cash flow.',
            'icon' => 'M 12 22 a 10 10 0 1 0 0 -20 a 10 10 0 0 0 0 20 z M 12 6 v 6 l 4 2', // Clock for aging/outstanding accounts
        ],

        [
            'title' => 'Revenue Recovery Needs Attention',
            'desc' => 'We identify underpayments, missed reimbursements, and billing errors to recover lost or delayed revenue.',
            'icon' => 'M 12 22 a 10 10 0 1 0 0 -20 a 10 10 0 0 0 0 20 z M 12 6 v 12 M 15 8 H 10 a 2 2 0 0 0 0 4 h 4 a 2 2 0 0 1 0 4 H 9', // Symmetrical Circle Dollar
        ],

        [
            'title' => 'Authorization Delays Are Increasing',
            'desc' => 'We coordinate prior authorization requests, communicate with payers, and reduce delays in treatment approvals and reimbursements.',
        ...
        [
            'title' => 'Hospital Revenue Needs Optimization',
            'desc' => 'We analyze your revenue cycle, uncover inefficiencies, and provide actionable strategies to improve collections, reduce denials, and strengthen financial performance.',
...
<section class="max-w-6xl mx-auto px-6 py-20">
    ...
    <div class="text-center mb-16">
        ...
        <div class="inline-block px-4 py-1.5 rounded-full text-[10px] font-bold tracking-widest uppercase border mb-8 bg-[var(--secondary)] text-white border-[var(--primary)]/20">
            WHAT OUR HOSPITAL BILLING TEAM HANDLES
        </div>
        ...
        <h2 class="text-4xl md:text-5xl font-bold font-gnarly text-slate-900 leading-[1.1] mb-6 capitalize">
            ...
            hospital operations — <span class="text-[var(--primary)]">taken care of.</span>
        </h2>
        
        <p class="text-slate-500 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
            From claim rejections and payment delays to insurance issues and reimbursement follow-ups, these are everyday challenges hospitals face. Instead of managing them internally, our hospital billing specialists handle them efficiently so your teams can focus on patient care.
        </p>
    </div>
...
<section class="max-w-6xl mx-auto px-6 py-12">
    ...
    <div class="w-full rounded-[40px] p-8 md:p-16 text-center" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto mb-10 text-left">
            ...
            <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/40 shadow-sm transition-transform hover:scale-[1.02] duration-300">
                <p class="text-[13px] md:text-[14px] font-medium leading-relaxed text-black">
                    Expanding your hospital operations? Our team scales billing support and administrative coordination with your growth.
                </p>
            </div>
