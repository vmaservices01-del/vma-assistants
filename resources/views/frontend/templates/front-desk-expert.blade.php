...
<section id="hero-section" class="relative w-full min-h-screen flex items-center justify-center bg-[#0a1931] py-20 px-6 overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <h1 class="text-2xl md:text-3xl lg:text-5xl max-w-2xl  mx-auto font-extrabold text-white leading-[1.1] tracking-tight mb-8 text-balance capitalize">
            Get Virtual Front Desk Expert Support  <br class="hidden md:block"> 
            <span class="text-white">for Your Healthcare Team </span>
        </h1>
    ...
    <div class="max-w-6xl mx-auto px-6 space-y-32">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div class="lg:col-span-7 order-2 lg:order-2">
                ...
                <div class="space-y-6 max-w-2xl">
                    <p class="text-slate-500 text-[16px] leading-relaxed">
                        Every interaction is managed with strict confidentiality and healthcare communication standards. Our HIPAA compliant virtual front desk support company ensures safe handling of patient information at all times.
                    <p class="text-slate-500 text-[16px] leading-relaxed">
                        From virtual assistant for patient scheduling and front desk operations to full communication management, every process is designed for reliability and consistency.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-16">
            ...
            <h2 class="text-[#111827] text-[30px] md:text-[42px] font-[900] leading-[1.1] tracking-[-0.04em] mb-6">
               Front Desk Systems For Platforms <span class="text-[var(--primary)]">You Already Use</span>
            </h2>
