...
<section id="hero-section" class="relative w-full min-h-screen flex items-center justify-center bg-[#0a1931] py-20 px-6 overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <p class="max-w-2xl mx-auto text-lg text-slate-300 mb-12 text-[16px]">
            Enhance patient experience and reduce administrative workload with trained virtual receptionists who manage your front desk operations efficiently.
        </p>
        ...
        <div class="mt-16 max-w-4xl mx-auto">
            <div class="flex flex-wrap items-center justify-center gap-x-10 gap-y-4 mb-6">
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    <span class="text-sm font-medium text-slate-300 tracking-wide">HIPAA compliant communication workflows</span>
                </div>
                <div class="hidden md:block w-px h-4 bg-white/10"></div>
                <div class="flex items-center gap-2.5">
                    <div class="flex-shrink-0 w-5 h-5 rounded-full bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20">
                    ...
                    <span class="text-sm font-medium text-slate-300 tracking-wide">Trained healthcare reception specialists</span>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-6xl mx-auto px-6">
        <div class="text-center max-w-4xl mx-auto mb-16">
            ...
            <h2 class="text-[26px] md:text-[36px] font-extrabold text-slate-900 mb-4 tracking-tight">How Virtual Medical Receptionist Support Works</h2>
            <p class="text-slate-500 text-lg">Skilled remote reception professionals managing daily patient communication and front-desk responsibilities so your in-house team can focus on care delivery.</p>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-12 animate-fade-in">
            ...
            <h2 class="text-[26px] md:text-[36px] font-extrabold text-slate-900 mb-2 tracking-tight capitalize">
                One complete <span class="text-[var(--primary)]"> front desk solution.</span>
            </h2>
            <p class="text-slate-500 text-md max-w-2xl mx-auto leading-relaxed">
                A structured virtual receptionist system designed to improve patient communication, reduce missed calls, and streamline clinic operations.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div class="lg:col-span-7 order-2 lg:order-1">
                <h2 class="text-[26px] md:text-[36px] font-extrabold text-slate-900 mb-8 tracking-tight leading-[1.15] text-balance capitalize">
                    More reception.  <span class="text-[var(--primary)]"> Less disruption.</span>
                </h2>
                <div class="space-y-6 max-w-2xl">
                    <p class="text-slate-500 text-[16px] leading-relaxed">
                        Missed calls and scheduling delays can directly affect patient satisfaction. Our virtual medical receptionist services ensure every patient interaction is handled promptly and professionally.
                    </p>
                    <p class="text-slate-500 text-[16px] leading-relaxed">
                        With outsourced medical receptionist services USA, clinics can maintain a responsive front desk without increasing overhead costs.
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div class="lg:col-span-7 order-2 lg:order-2">
                <h2 class="text-[26px] md:text-[36px] font-extrabold text-slate-900 mb-8 tracking-tight leading-[1.15] text-balance">
                    Every Contact. <span class="text-[var(--primary)]">Properly Protected.</span>
                </h2>
                <div class="space-y-6 max-w-2xl">
                    <p class="text-slate-500 text-[16px] leading-relaxed">
                        Patient trust depends on consistent and secure communication. Our HIPAA compliant virtual front desk receptionist for clinics ensures all interactions are handled with strict confidentiality and professionalism.
                    </p>
                    <p class="text-slate-500 text-[16px] leading-relaxed">
                        From appointment coordination to remote patient communication and receptionist support services, every process is designed to enhance care experience.
                    </p>
                </div>
            </div>
        </div>
...
<section class="py-20 px-6 bg-white antialiased">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-20">
            <h2 class="text-[#111827]  text-[26px] md:text-[36px] font-[900] leading-[1.1] tracking-[-0.04em] mb-6 capitalize">
                Why Choose VMA Virtual Medical Receptionist Services
            </h2>
            ...
            <div class="lg:col-span-7">
                <div class="max-w-xl">
                    ...
                    <p class="text-slate-500 text-[16px] mb-10">
                        Let’s understand your clinic’s front desk needs and show how our virtual medical receptionist services can improve patient communication and scheduling efficiency.
                    </p>
