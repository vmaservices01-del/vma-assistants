...
<section id="hero-section" class="relative w-full min-h-screen flex items-center justify-center bg-[#0a1931] py-20 px-6 overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <h1 class="text-2xl md:text-3xl lg:text-5xl max-w-4xl mx-auto font-extrabold text-white leading-[1.1] tracking-tight mb-8 text-balance">
            Streamline Your Medical Billing & Coding <br class="hidden md:block">
            <span class="text-white">with Remote Revenue Support</span>
        </h1>
            ...
            @php 
                $fees = [
                    ...
                    [
                        ...
                        'desc' => 'HIPAA-aligned billing and coding processes with strict data protection.',
                    ...
                    [
                        ...
                        'desc' => 'From coding to claim submission and payment posting support',
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-16">
            ...
            <h2 class="text-[#111827] text-[30px] md:text-[42px] font-[900] leading-[1.1] tracking-[-0.04em] mb-6">
               Revenue Platforms We Work <span class="text-[var(--primary)]">With Every Day</span>
            </h2>
            ...
            @php
                $features = [
                    [
                        ...
                        'desc' => 'Certified professionals trained in specialty-specific billing and coding requirements.'
                    ],
                    [
                        'title' => 'Cost-Effective Outsourcing',
                        'desc' => 'Reduce operational costs by up to 65% with outsourced medical billing and coding services.'
                    ],
                    [
                        'title' => 'Full HIPAA Compliance',
                        'desc' => 'Secure workflows aligned with HIPAA, SOC 2 Type II, ISO 27001, and GDPR standards.'
                    ],
                    [
                        'title' => 'Faster Claim Processing',
                        'desc' => 'Clean claims submission reduces delays and improves reimbursement speed.'
                    ],
                    [
                        'title' => 'Flexible Staffing Model',
                        'desc' => 'Scale billing and coding support based on your practice volume.'
                    ],
                    [
                        'title' => 'No Upfront Risk',
                        'desc' => 'Start without commitment and pay only when you are satisfied with performance.'
                    ]
                ];
            @endphp
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <h2 class="text-white text-[42px] md:text-[46px] font-extrabold leading-[1.1] tracking-[-0.03em] mb-6 capitalize">
           Meet your medical billing <br>
            and <span class="bg-gradient-to-r from-[#000] via-[#000] to-[#000] bg-clip-text text-transparent">coding specialists in just 5 days</span>
        </h2>
