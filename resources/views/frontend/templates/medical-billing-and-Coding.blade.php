...
<section id="hero-section" class="relative w-full min-h-screen flex items-center justify-center bg-[#0a1931] py-20 px-6 overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <h1 class="text-2xl md:text-3xl lg:text-5xl max-w-4xl mx-auto font-extrabold text-white leading-[1.1] tracking-tight mb-8 text-balance">
            Streamline Your Revenue Cycle with <br class="hidden md:block">
            <span class="text-white">Billing & Coding Support</span>
        </h1>

        <p class="max-w-3xl mx-auto text-lg text-slate-300 mb-12 text-[16px]">
            Reduce administrative burden, eliminate billing errors, and accelerate reimbursements with professional medical billing and coding services designed for modern healthcare practices.
        </p>
        ...
        <div class="mt-16 max-w-4xl mx-auto">
            <div class="flex flex-wrap items-center justify-center gap-x-10 gap-y-4 mb-6">
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    <span class="text-sm font-medium text-slate-300 tracking-wide">Certified billing and coding specialists</span>
                </div>
                <div class="hidden md:block w-px h-4 bg-white/10"></div>
                <div class="flex items-center gap-2.5">
                    <div class="flex-shrink-0 w-5 h-5 rounded-full bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20">
                    ...
                    <span class="text-sm font-medium text-slate-300 tracking-wide"> HIPAA compliant billing workflows</span>
                </div>
            </div>
        </div>
    </div>
...
<section class="max-w-6xl mx-auto py-14 bg-white border-b border-slate-50">
    <div class="text-center mb-10">
        <h2 class="text-xs font-bold text-[13px] leading-relaxed text-gray-400 tracking-[0.2em] uppercase">
             Trusted by clinics, hospitals, and specialty providers
        </h2>
    </div>
            ...
            @php 
                $cards = [
                    [
                        ...
                        'icon' => 'M 14 2 H 6 a 2 2 0 0 0 -2 2 v 16 a 2 2 0 0 0 2 2 h 12 a 2 2 0 0 0 2 -2 V 8 z M 14 2 v 6 h 6 M 16 13 H 8 M 16 17 H 8 M 10 9 H 8' // Structured documentation page
                    ],
                    [
                        'title' => 'Claims Submission',
                        'desc' => 'End-to-end claim creation, scrubbing, and submission to reduce errors and accelerate reimbursements.',
                        'icon' => 'M 14 2 H 6 a 2 2 0 0 0 -2 2 v 16 a 2 2 0 0 0 2 2 h 12 a 2 2 0 0 0 2 -2 V 8 z M 14 2 v 6 h 6 M 9 15 l 2 2 4 -4' // Document check (successful claim)
                    ],
                    [
                        'title' => 'Denial Management',
                        'desc' => 'Identification, correction, and resubmission of denied or rejected claims to maximize collections.',
                        'icon' => 'M 15 2 H 6 a 2 2 0 0 0 -2 2 v 16 a 2 2 0 0 0 2 2 h 12 a 2 2 0 0 0 2 -2 V 7 Z M 14 2 v 4 a 1 1 0 0 0 1 1 h 4 M 12 9 v 4 M 12 17 h 0.01' // Document sheet with alert exclamation
                    ],
                    [
            ...
            @php 
                $fees = [
                    [
                        ...
                        'icon' => 'M 17 21 v -2 a 4 4 0 0 0 -4 -4 H 5 a 4 4 0 0 0 -4 4 v 2 M 9 11 a 4 4 0 1 0 0 -8 a 4 4 0 1 0 0 8 M 23 21 v -2 a 4 4 0 0 0 -3 -3.87 M 16 3.13 a 4 4 0 0 1 0 7.75' // Multi-specialist team (Users)
                    ],
                    [
                    ...
                    [
                        ...
                        'icon' => 'M 9 5 H 7 a 2 2 0 0 0 -2 2 v 12 a 2 2 0 0 0 2 2 h 10 a 2 2 0 0 0 2 -2 V 7 a 2 2 0 0 0 -2 -2 h -2 M 9 5 a 2 2 0 0 0 2 2 h 2 a 2 2 0 0 0 2 -2 M 9 5 a 2 2 0 1 2 -2 h 2 a 2 2 0 1 2 2 M 9 14 l 2 2 4 -4' // Lifecycle Clipboard checklist
                    ]
                ];
            @endphp
    ...
    <div class="max-w-6xl mx-auto px-6 space-y-32">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div class="lg:col-span-7 order-2 lg:order-1">
                <h2 class="text-[26px] md:text-[36px] font-extrabold text-slate-900 mb-8 tracking-tight leading-[1.15] text-balance">
                    Reduce Errors. <span class="text-[var(--primary)]"> Increase Revenue. </span>
                </h2>
                <div class="space-y-6 max-w-2xl">
                    <p class="text-slate-500 text-[16px] leading-relaxed">
                       Medical billing errors and coding inaccuracies can directly impact your practice revenue. Our outsourced medical billing and coding services ensure every claim is clean, compliant, and submitted correctly the first time.
                    </p>
                    <p class="text-slate-500 text-[16px] leading-relaxed">
                        With expert revenue cycle management for healthcare providers, you gain better cash flow, fewer denials, and more time to focus on patient care.
                    </p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div class="lg:col-span-7 order-2 lg:order-2">
                <h2 class="text-[26px] md:text-[36px] font-extrabold text-slate-900 mb-8 tracking-tight leading-[1.15] text-balance">
                   Secure Billing. <span class="text-[var(--primary)]">Reliable Outcomes.</span>
                </h2>
                <div class="space-y-6 max-w-2xl">
                    <p class="text-slate-500 text-[16px] leading-relaxed">
                        Patient data security is at the core of every billing process we handle. As a HIPAA compliant medical billing company, we ensure all coding, billing, and claims processing workflows meet strict regulatory standards.
                    </p>
                    <p class="text-slate-500 text-[16px] leading-relaxed">
                        From accurate medical coding services for clinics to full insurance claim billing and coding solutions, your practice stays compliant while maximizing revenue performance.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-16">
            ...
            <h2 class="text-[#111827] text-[26px] md:text-[36px] font-[900] leading-[1.1] tracking-[-0.04em] mb-6">
               Revenue Platforms <span class="text-[var(--primary)]">We Work With Every Day</span>
            </h2>
            <p class="text-black text-[14px] md:text-[16px] leading-relaxed max-w-2xl mx-auto font-normal">
                Our certified medical billing specialists are trained to work across leading healthcare and billing platforms used by modern practices.
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @php
                $ehrList = [
                    [
                        'title' => 'Athenahealth',
                        'desc' => 'Billing, claims management, and RCM workflows',
                        'icon' => 'building'
                    ],
                    [
                        'title' => 'eClinicalWorks',
                        'desc' => 'Coding support and billing documentation',
                        'icon' => 'building'
                    ],
                    [
                        'title' => 'Kareo / Tebra',
                        'desc' => 'Medical billing and revenue cycle support',
                        'icon' => 'building'
                    ],
                    [
                        'title' => 'Availity',
                        'desc' => 'Insurance eligibility and claims processing',
                        'icon' => 'lock'
                    ],
                    [
                        'title' => 'NextGen Healthcare',
                        'desc' => 'Billing operations and clinical data coordination',
                        'icon' => 'building'
                    ],
                    [
                        'title' => 'Epic Systems',
                        'desc' => 'Enterprise billing and coding workflows',
                        'icon' => 'building'
                    ],
                    [
                        'title' => 'CareCloud',
                        'desc' => 'Revenue cycle management and practice support',
                        'icon' => 'building'
                    ],
                    [
                        'title' => 'RingCentral',
                        'desc' => 'Patient communication and billing coordination',
                        'icon' => 'phone'
                    ]
                ];
            @endphp
...
<section class="py-20 px-6 bg-white antialiased">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-20">
            <h2 class="text-[#111827]  text-[26px] md:text-[36px] font-[900] leading-[1.1] tracking-[-0.04em] mb-6">
                Why Hire With VMA Medical Billing & Coding Services
            </h2>
            ...
            @php
                $features = [
                    ...
                    [
                        ...
                        'desc' => 'Certified professionals trained in specialty-specific medical billing and coding requirements to ensure accuracy and compliance.'
                    ],

                    [
                        'title' => 'Pre-Vetted & Highly Skilled Talent',
                        'desc' => 'Work with professionals from a 2–4% acceptance pipeline, rigorously vetted and trained to deliver results from day one.'
                    ],

                    [
                        'title' => 'Cost-Effective Outsourcing',
                        'desc' => 'Reduce operational and staffing costs by up to 65–70% compared to traditional in-house teams.'
                    ],

                    [
                        'title' => 'Full Compliance & Security',
                        'desc' => 'HIPAA-compliant workflows with SOC 2 Type II, ISO 27001, and GDPR-aligned security standards.'
                    ],

                    [
                        'title' => 'Faster Claim & Workflow Processing',
                        'desc' => 'Clean claim submission and optimized operations reduce delays and improve turnaround time and reimbursements.'
                    ],

                    [
                        'title' => 'Flexible & Scalable Staffing',
                        'desc' => 'Scale your billing, coding, and remote talent support up or down based on your business needs.'
                    ],

                    [
                        'title' => 'Risk-Free Hiring Model',
                        'desc' => 'No upfront fees or commitments—pay only when you’re satisfied with the performance and fit.'
                    ],

                    [
                        'title' => 'End-to-End Workforce Management',
                        'desc' => 'We handle recruiting, onboarding, payroll, and benefits so you can focus on growing your business.'
                    ],
            ...
            <div class="lg:col-span-7">
                <div class="max-w-xl">
                    ...
                    <p class="text-slate-500 text-[16px] mb-10">
                       Let’s connect to understand your practice’s billing challenges and how our medical billing services for healthcare providers can improve your revenue cycle performance.
                    </p>
                    ...
                    <form action="{{ route('backend.discovery.submit') }}" method="POST" class="space-y-4">
                        ...
                        <p class="text-[11px] leading-relaxed text-slate-400 mt-6">
                           By submitting this form, you agree to our Privacy Policy and consent to receive emails and SMS updates. You can unsubscribe anytime.
                        </p>
...
<section class="py-20 px-6 bg-primary antialiased text-center">
    <div class="max-w-4xl mx-auto">
        ...
        <h2 class="text-white text-[42px] md:text-[46px] font-extrabold leading-[1.1] tracking-[-0.03em] mb-6 capitalize">
           Meet your medical billing <br>
            and <span class="bg-gradient-to-r from-[#000] via-[#000] to-[#000] bg-clip-text text-transparent">coding specialists in just  7 days</span>
        </h2>

        <!-- Subheading -->
        <p class="text-white/80 text-[13px] md:text-[16px] leading-relaxed max-w-2xl mx-auto mb-8 font-normal">
            Book a demo to see how our certified experts improve reimbursement performance.<br class="hidden md:block">
            No overhead. No long-term contracts. No risk.
        </p>
