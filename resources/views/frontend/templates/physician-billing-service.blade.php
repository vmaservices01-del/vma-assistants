    ...
    <div class="max-w-6xl mx-auto px-6 lg:px-8 w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex flex-col justify-center">
            ...
            <div class="inline-flex items-center gap-2 px-4 py-1.5 bg-[#f0fdf4] text-[#059669] rounded-full text-xs font-semibold border border-[#dcfce7] mb-6 w-fit">
                ...
                18+ healthcare practices hired VMA physician billing team
            </div>
            ...
            <p class="text-slate-500 text-[16px] leading-relaxed mb-8 max-w-lg font-sans">
                VMA handles the claims processing, denial management, coding support, and reimbursement optimization so you can focus on what matters most, your patients. Maximize your practice revenue while reducing administrative burden.
            </p>
...
<section class="max-w-6xl mx-auto px-6 py-20 text-center">
    ...
    <div class="inline-flex px-3 py-1 mb-6 text-[11px] font-bold text-primary uppercase tracking-widest bg-indigo-50/50 rounded-full border border-indigo-100">
        PHYSICIAN BILLING SOLUTIONS FOR HEALTHCARE TEAMS
    </div>

    <!-- Title & Desc -->
    <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tighter mb-4 capitalize">
       Smart Physician Billing Support For Healthcare Teams
    </h2>
    <p class="text-gray-500 mb-10 max-w-lg mx-auto leading-relaxed">
        VMA physician billing experts streamline claims processing, insurance verification, prior authorizations, and reimbursement workflows to improve operational efficiency and revenue performance.
    </p>

    <!-- Browse Button -->
    <button class="mb-16 border-2 border-gray-200 hover:border-gray-300 px-6 py-3 rounded-xl font-semibold transition-all">
       Explore Physician Billing Services →
    </button>
        ...
        @php
            $roles = [
                [
                    ...
                    'desc' => 'Maintains accurate patient records while supporting compliant physician workflows.', 
                ...
                [
                    ...
                    'desc' => 'Supports scheduling, coordination, and daily physician administrative tasks remotely.', 
                    'url' => '/roles/coder',
                    'icon' => 'M8 2v4 M16 2v4 M3 10h18 M5 4h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z M9 16l2 2 4-4' // Calendar scheduler with coordination checkmark
                ],
                [
                    ...
                    'url' => '/roles/scribe',
                    'icon' => 'M12 20h9 M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z' // Writing pen/pencil updating documentation
                ],
                [
                    'title' => 'Revenue Specialist', 
                    'desc' => 'Manages physician billing workflows and ensures accurate reimbursement processing.', 
                    'url' => '/roles/scribe',
                    'icon' => 'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6 M12 11v6 M15 13H9.5a1.5 1.5 0 0 0 0 3h3a1.5 1.5 0 0 1 0 3H9' // Financial ledger with Dollar sign
                ],
                [
                    'title' => 'EMR Assistant', 
                    'desc' => 'Updates and manages electronic medical records with accuracy and efficiency.', 
                    'url' => '/roles/scribe',
                    'icon' => 'M4 21h16a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2z M2 10h20 M6 6h1 M10 6h1 M14 6h1' // Digital system/EMR monitor UI
                ],
                [
                    'title' => 'Insurance Coordinator', 
                    'desc' => 'Helps organize billing information, coding details, and insurance-related documentation.', 
                    'url' => '/roles/scribe',
                    'icon' => 'M21 4H3a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2z M1 10h22 M4 15h2 M8 15h4' // Insurance Coverage / ID Card
                ]
            ];
        @endphp
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-16">
            ...
            <p class="text-black text-[14px] md:text-[16px] leading-relaxed max-w-2xl mx-auto font-normal">
                Stop wasting time on software training. VMA 4-week intensive training program provides vetted and certified professionals skilled in physician documentation workflows and complex medical billing cycles. We hit the ground running so your practice never misses a beat.
            </p>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-12 animate-fade-in">
            ...
            <p class="text-slate-500 text-md max-w-2xl mx-auto leading-relaxed">
                VMA provides complete affordable physician billing support services designed to help healthcare providers improve operational efficiency with reliable infrastructure and trained professionals.
            </p>
        </div>
            ...
            @php
                $fees = [
                    [
                        ...
                        'desc' => 'Fully managed onboarding for your dedicated physician billing support team.',
                    ...
                    [
                        ...
                        'icon' => 'M 9 5 H 7 a 2 2 0 0 0 -2 2 v 12 a 2 2 0 0 0 2 2 h 10 a 2 2 0 0 0 2 -2 V 7 a 2 2 0 0 0 -2 -2 h -2 M 9 5 a 2 2 0 0 0 2 2 h 2 a 2 2 0 0 0 2 -2 M 9 5 a 2 2 0 0 1 2 -2 h 2 a 2 2 0 0 1 2 2 M 9 14 l 2 2 4 -4' // Clipboard Check
                    ],
                    [
                        'title' => 'Data Protection',
                        'desc' => 'HIPAA-ready processes for secure physician billing and administrative operations.',
                        'icon' => 'M 12 22 s 8 -4 8 -10 V 5 l -8 -3 -8 3 v 7 c 0 6 8 10 8 10 z M 9 11 l 2 2 4 -4' // Shield Check
                    ],
                    [
                        'title' => 'Client Coordination',
                        'desc' => 'Simple agreements and ongoing support for smooth billing operations.',
                        'icon' => 'M 17 21 v -2 a 4 4 0 0 0 -4 -4 H 5 a 4 4 0 0 0 -4 4 v 2 M 9 11 a 4 4 0 1 0 0 -8 a 4 4 0 1 0 0 8 M 23 21 v -2 a 4 4 0 0 0 -3 -3.87 M 16 3.13 a 4 4 0 0 1 0 7.75' // Users
                    ],
                    [
                        'title' => 'Medical Claims Billing',
                        'desc' => 'Accurate and timely physician claim submissions to ensure faster reimbursements.',
                        'icon' => 'M 14 2 H 6 a 2 2 0 0 0 -2 2 v 16 a 2 2 0 0 0 2 2 h 12 a 2 2 0 0 0 2 -2 V 8 z M 14 2 v 6 h 6 M 12 11 v 6 M 15 13 H 9.5 a 1.5 1.5 0 0 0 0 3 h 3 a 1.5 1.5 0 0 1 0 3 H 9' // Document Text with Dollar (Invoice)
                    ],
                    [
                        'title' => 'Eligibility Verification',
                        'desc' => 'Efficient eligibility checks and coverage verification for smooth billing operations.',
                        'icon' => 'M 12 22 a 10 10 0 1 0 0 -20 a 10 10 0 0 0 0 20 z M 9 12 l 2 2 4 -4' // Badge Check / Verification
                    ],
                    [
                        'title' => 'Revenue Recovery',
                        'desc' => 'Proactive claim tracking, denial resolution, and payment follow-ups to maximize revenue.',
                        'icon' => 'M 12 2 v 20 M 17 5 H 9.5 a 3.5 3.5 0 0 0 0 7 h 5 a 3.5 3.5 0 0 1 0 7 H 6 M 3 12 a 9 9 0 0 1 15 -6.7 L 21 8 M 21 3 v 5 h -5' // Currency Recovery Loop
                    ],
                    [
                        'title' => 'Compliance Reporting',
                        'desc' => 'HIPAA-compliant billing processes with financial reporting and operational transparency.',
                        'icon' => 'M 18 20 V 10 M 12 20 V 4 M 6 20 v -6 M 3 20 h 18' // Chart Bar
                    ]
                ];
            @endphp
...
@php
    $challenges = [
        [
            'title' => 'Reimbursement Issues Are Increasing',
            'desc' => 'Our physician billing specialists investigate the root cause of denials, identify recurring issues, and implement corrective actions to improve first-pass claim acceptance and reimbursement rates.',
        ...
        [
            'title' => 'Coverage Verification Delays',
        ...
        [
            'title' => 'Your Clinical Practice Is Expanding',
            'desc' => 'As your medical practice expands, billing complexity increases. We help manage higher claim volumes, streamline workflows, and ensure your revenue cycle scales efficiently alongside your growth.',
            'icon' => 'M 23 6 H 17 M 23 6 v 6 M 23 6 L 13.5 15.5 L 8.5 10.5 L 1 18' // Trending Up Arrow
        ],
        [
            'title' => 'Administrative Workload Is Growing',
            'desc' => 'Whether it\'s new payer requirements, physician billing regulations, or software updates, our specialists provide the expertise needed to keep billing operations accurate and compliant.',
            'icon' => 'M 12 2 L 2 7 l 10 5 l 10 -5 Z M 2 17 l 10 5 l 10 -5 M 2 12 l 10 5 l 10 -5' // Layers (Administrative Workload)
        ],
        [
            'title' => 'Pending Payments Are Accumulating',
        ...
        [
            'title' => 'Revenue Recovery Needs Improvement',
            'desc' => 'Our physician billing experts identify underpayments, missed reimbursements, and billing errors, helping recover revenue that might otherwise remain uncollected.',
            'icon' => 'M 12 22 a 10 10 0 1 0 0 -20 a 10 10 0 0 0 0 20 z M 12 6 v 12 M 15 8 H 10 a 2 2 0 0 0 0 4 h 4 a 2 2 0 0 1 0 4 H 9' // Circle Dollar Sign (Clean & Centered)
        ],
        [
            'title' => 'Approval Processing Is Delayed',
            'desc' => 'Treatment approvals can slow patient care and reimbursement. We coordinate prior authorization processes, communicate with payers, and help minimize delays.',
            'icon' => 'M 21 2 L 11 12 M 21 2 v 6 M 21 2 h -6 M 11 12 a 5 5 0 1 0 -7.07 7.07 a 5 5 0 0 0 7.07 -7.07 z' // Key (Approvals/Access)
        ],
        [
            'title' => 'Practice Revenue Needs Optimization',
            'desc' => 'Our billing specialists analyze your practice revenue cycle, uncover inefficiencies, and provide actionable recommendations to improve collections, reduce denials, and strengthen financial performance.',
...
<section class="max-w-6xl mx-auto px-6 py-20">
    ...
    <div class="text-center mb-16">
        ...
        <div class="inline-block px-4 py-1.5 rounded-full text-[10px] font-bold tracking-widest uppercase border mb-8 bg-[var(--secondary)] text-white border-[var(--primary)]/20">
            WHAT OUR PHYSICIAN BILLING TEAM HANDLES
        </div>
        ...
        <h2 class="text-4xl md:text-5xl font-bold font-gnarly text-slate-900 leading-[1.1] mb-6 capitalize">
            ...
            your medical practice — <span class="text-[var(--primary)]">taken care of.</span>
        </h2>
        
        <p class="text-slate-500 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
            From claim rejections and payment delays to insurance issues and follow-ups, these are everyday challenges physician practices face. Instead of managing them on your own, our physician billing specialists handle them efficiently so you can focus on patient care.
        </p>
    </div>
...
<section class="max-w-6xl mx-auto px-6 py-12">
    ...
    <div class="w-full rounded-[40px] p-8 md:p-16 text-center" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto mb-10 text-left">
            ...
            <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/40 shadow-sm transition-transform hover:scale-[1.02] duration-300">
                <p class="text-[13px] md:text-[14px] font-medium leading-relaxed text-black">
                   Expanding your physician practice? Our team scales billing operations and administrative support with your growth.
                </p>
            </div>
        ...
        <!-- Footer Text -->
        <p class="text-[13px] font-bold mb-6 uppercase tracking-wider" style="color: var(--primary); capitalize">
