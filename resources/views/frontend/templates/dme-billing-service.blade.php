    ...
    <div class="max-w-6xl mx-auto px-6 lg:px-8 w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex flex-col justify-center">
            ...
            <div class="inline-flex items-center gap-2 px-4 py-1.5 bg-[#f0fdf4] text-[#059669] rounded-full text-xs font-semibold border border-[#dcfce7] mb-6 w-fit">
                ...
                10 + healthcare providers partnered with VMA DME billing team
            </div>

            <!-- Heading -->
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.05] tracking-tight text-[#0F172A] mb-6 font-gnarly capitalize">
                Let providers <br>
                focus on <span class="text-[#7C3AED]"> patient support.</span>
            </h1>

            <!-- Description -->
            <p class="text-slate-500 text-[16px] leading-relaxed mb-8 max-w-lg font-sans">
                VMA handles DME claims processing, denial management, HCPCS coding support, and reimbursement optimization so your team can focus on delivering quality patient care. Maximize revenue while reducing administrative burden across your DME operations.
            </p>
...
<section class="max-w-6xl mx-auto px-6 py-20 text-center">
    ...
    <div class="inline-flex px-3 py-1 mb-6 text-[11px] font-bold text-primary uppercase tracking-widest bg-indigo-50/50 rounded-full border border-indigo-100">
        DME BILLING SOLUTIONS FOR HEALTHCARE TEAMS
    </div>

    <!-- Title & Desc -->
    <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tighter mb-4 capitalize">
        Smart DME Billing Support For Healthcare Providers
    </h2>
    <p class="text-gray-500 mb-10 max-w-lg mx-auto leading-relaxed">
        VMA DME billing experts streamline claims processing, insurance verification, prior authorizations, and reimbursement workflows to improve operational efficiency and revenue performance.
    </p>
    ...
    <div class="grid md:grid-cols-3 gap-6 text-left">
        @php
            $roles = [
                [
                    'title' => 'DME Specialist',
                    'desc' => 'Maintains accurate patient records while supporting compliant DME workflows.',
                    'url' => '/roles/dme-specialist',
                ...
                [
                    ...
                    'desc' => 'Supports scheduling, coordination, and daily DME administrative operations remotely.',
                    'url' => '/roles/equipment-coordinator',
                ...
                [
                    ...
                    'desc' => 'Manages prior authorization requests and updates documentation for equipment approvals.',
                    'url' => '/roles/authorization-specialist',
                ...
                [
                    ...
                    'desc' => 'Oversees DME billing workflows and ensures accurate reimbursement processing.',
                    'url' => '/roles/revenue-coordinator',
                ...
                [
                    ...
                    'desc' => 'Updates and manages billing records with accuracy and operational efficiency.',
                    'url' => '/roles/billing-assistant',
                    'icon' => 'M 14 2 H 6 a 2 2 0 0 0 -2 2 v 16 a 2 2 0 0 0 2 2 h 12 a 2 2 0 0 0 2 -2 V 8 z M 14 2 v 6 h 6 M 8 12 h 8 M 8 16 h 5' // Billing Document Page
                ],
                [
                    'title' => 'Verification Specialist',
                    'desc' => 'Helps organize billing information, HCPCS coding details, and insurance-related documentation.',
                    'url' => '/roles/insurance-verification-specialist',
                    'icon' => 'M 21 4 H 3 a 2 2 0 0 0 -2 2 v 12 a 2 2 0 0 0 2 2 h 18 a 2 2 0 0 0 2 -2 V 6 a 2 2 0 0 0 -2 -2 z M 1 10 h 22 M 4 15 h 2 M 8 15 h 4' // Verification ID Card
                ]
            ];
        @endphp
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-16">
            ...
            <h2 class="text-[#111827] text-[26px] md:text-[36px] font-[900] leading-[1.1] tracking-[-0.04em] mb-6 capitalize">
                Certified in the Systems  <span class="text-[var(--primary)]">You Already Use</span>
            </h2>
            <p class="text-black text-[14px] md:text-[16px] leading-relaxed max-w-2xl mx-auto font-normal">
                Stop wasting time on software training. VMA 4-week intensive training program provides vetted and certified professionals skilled in DME documentation workflows and complex reimbursement cycles. We hit the ground running so your operations never miss a beat.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            $ehrList = [
                [
                'title' => 'Brightree',
                'desc' => 'Claims Management, Inventory Tracking, Patient Billing',
                'icon' => 'building'
                ],
                [
                'title' => 'Kareo',
                'desc' => 'Scheduling, Billing, Patient Communications',
                'icon' => 'building'
                ],
                [
                'title' => 'AdvancedMD',
                'desc' => 'RCM, Practice Management, Workflow Automation',
                'icon' => 'building'
                ],
                [
                'title' => 'Waystar',
                'desc' => 'Claims Processing, Eligibility Verification, Payment Tracking',
                'icon' => 'building'
                ],
                [
                'title' => 'Availity',
                'desc' => 'Eligibility Checks, Authorizations, Claims Management',
                'icon' => 'lock'
                ],
                [
                'title' => 'NaviNet',
                'desc' => 'Payer Communications, Insurance Verification, Claims Status',
                'icon' => 'lock'
                ],
                [
                'title' => 'RingCentral',
                ...
                [
                'title' => 'Phreesia',
                'desc' => 'Digital Intake, Payments, Patient Engagement',
                'icon' => 'chart'
                ],
            ];
            @endphp
    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-12 animate-fade-in">
            ...
            <p class="text-slate-500 text-md max-w-2xl mx-auto leading-relaxed">
                VMA provides complete affordable DME billing support services designed to help healthcare providers improve operational efficiency with reliable infrastructure and trained professionals.
            </p>
        </div>
            ...
            @php 
                $fees = [
                    [
                        ...
                        'description' => 'Fully managed onboarding for your dedicated DME billing support team.',
                        'included' => true,
                    ...
                    [
                        ...
                        'description' => 'Structured workflows to ensure consistent delivery and operational efficiency.',
                        'included' => true,
                    ...
                    [
                        ...
                        'description' => 'HIPAA-ready processes for secure DME billing and administrative operations.',
                        'included' => true,
                    ...
                    [
                        ...
                        'description' => 'Simple agreements and ongoing support for smooth DME billing operations.',
                        'included' => true,
                        'icon' => 'M 17 21 v -2 a 4 4 0 0 0 -4 -4 H 5 a 4 4 0 0 0 -4 4 v 2 M 9 11 a 4 4 0 1 0 0 -8 a 4 4 0 1 0 0 8 M 23 21 v -2 a 4 4 0 0 0 -3 -3.87 M 16 3.13 a 4 4 0 0 1 0 7.75' // Users Coordination
                    ],
                    [
                        'title' => 'DME Management',
                        'description' => 'Accurate and timely DME claim submissions to ensure faster reimbursements.',
                        'included' => true,
                        'icon' => 'M 14 2 H 6 a 2 2 0 0 0 -2 2 v 16 a 2 2 0 0 0 2 2 h 12 a 2 2 0 0 0 2 -2 V 8 z M 14 2 v 6 h 6 M 8 12 h 8 M 8 16 h 5' // Document/DME Claims
                    ],
                    [
                        'title' => 'Eligibility Confirmation',
                        'description' => 'Efficient eligibility checks and coverage verification for smooth billing operations.',
                        'included' => true,
                        'icon' => 'M 12 22 s 8 -4 8 -10 V 5 l -8 -3 -8 3 v 7 c 0 6 8 10 8 10 z M 9 11 l 2 2 4 -4' // Shield Check
                    ],
                    [
                        'title' => 'Accounts Receivable',
                        'description' => 'Proactive claim tracking, denial resolution, and payment follow-ups to maximize revenue.',
                        'included' => true,
                        'icon' => 'M 12 22 a 10 10 0 1 0 0 -20 a 10 10 0 0 0 0 20 z M 12 6 v 12 M 15 8 H 10 a 2 2 0 0 0 0 4 h 4 a 2 2 0 0 1 0 4 H 9' // Symmetrical Circle Dollar
                    ],
                    [
                        'title' => 'HIPAA Compliance',
                        'description' => 'HIPAA-compliant billing processes with detailed financial reporting and operational transparency.',
                        'included' => true,
...
<section class="max-w-6xl mx-auto px-6 py-12">
    @php
        $customerBenefits = [
            'Improves DME claim accuracy & reimbursement rates',
            'Reduces billing errors and rejected claims',
            'Streamlines DME revenue cycle operations',
        ...
        $talentBenefits = [
            ...
            'Ensures smoother equipment billing workflows',
    ...
    <div class="relative w-full rounded-[40px] overflow-hidden p-8 md:p-12 lg:p-18 bg-gradient-to-br from-[#0d8276] via-[#115e59] to-[#4c1d95] text-white">
        ...
        <div class="relative z-10">
            ...
            <p class="text-white/70 text-[14px] max-w-3xl leading-relaxed mb-10 font-sans">
                Our DME Billing Service account manager isn’t just your billing contact. They serve as the single point of contact for both your organization and our billing team , a bridge between both sides. When there’s a concern, they already have context from every stage of the process. When there’s a discrepancy, they resolve it. When there’s an opportunity, they coordinate and optimize your reimbursement workflow.
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                <div class="lg:col-span-5">
                    <h3 class="text-white/50 text-[14px] font-bold tracking-widest uppercase mb-6">FOR YOUR OPERATIONS</h3>
                    <ul class="space-y-2">
                ...
                <!-- For Your Talent -->
                <div class="lg:col-span-5">
                    <h3 class="text-white/50 text-[14px] font-bold tracking-widest uppercase mb-6">FOR YOUR PATIENTS & WORKFLOWS</h3>
                    <ul class="space-y-2">
...
$challenges = [
    ...
    [
        'title' => 'DME Claim Rejections Are Increasing',
        'desc' => 'Our DME billing specialists investigate denial patterns, identify recurring payer issues, review HCPCS coding inconsistencies, and implement corrective actions to improve first-pass claim acceptance and reimbursement rates.',
        'icon' => 'M 15 2 H 6 a 2 2 0 0 0 -2 2 v 16 a 2 2 0 0 0 2 2 h 12 a 2 2 0 0 0 2 -2 V 7 Z M 14 2 v 4 a 1 1 0 0 0 1 1 h 4 M 12 9 v 4 M 12 17 h 0.01' // Document/File with Alert Exclamation
    ],

    [
        'title' => 'Insurance Verification Delays',
        'desc' => 'Coverage discrepancies and eligibility issues can delay payments. Our team verifies patient benefits, confirms policy coverage details, validates equipment eligibility requirements, and resolves insurance-related billing obstacles.',
        'icon' => 'M 12 22 s 8 -4 8 -10 V 5 l -8 -3 -8 3 v 7 c 0 6 8 10 8 10 z M 9 11 l 2 2 4 -4' // Verification Shield
    ],

    [
        'title' => 'Your DME Operations Are Expanding',
        'desc' => 'As your organization grows, billing complexity increases. We help manage higher claim volumes, coordinate equipment documentation, streamline reimbursement workflows, and ensure scalable billing cycles.',
        'icon' => 'M 23 6 H 17 M 23 6 v 6 M 23 6 L 13.5 15.5 L 8.5 10.5 L 1 18' // Trending Up Arrow
    ],

    [
        'title' => 'Administrative Tasks Are Increasing',
        'desc' => 'We handle payer requirements, DME regulations, authorization protocols, and software updates to keep billing operations accurate, organized, and compliant.',
        'icon' => 'M 12 2 L 2 7 l 10 5 l 10 -5 Z M 2 17 l 10 5 l 10 -5 M 2 12 l 10 5 l 10 -5' // Stacked Layers (Administrative Tasks)
    ],

    [
        'title' => 'Outstanding Claims Are Accumulating',
        'desc' => 'We follow up on aging accounts, track unresolved equipment claims, appeal denied reimbursements, and accelerate payer payments to improve cash flow.',
        'icon' => 'M 12 22 a 10 10 0 1 0 0 -20 a 10 10 0 0 0 0 20 z M 12 6 v 6 l 4 2' // Pending Timer/Clock
    ],

    [
        'title' => 'Revenue Recovery Needs Attention',
        'desc' => 'We identify underpayments, missed reimbursements, billing inconsistencies, and coding errors to recover delayed or uncollected revenue.',
        'icon' => 'M 12 22 a 10 10 0 1 0 0 -20 a 10 10 0 0 0 0 20 z M 12 6 v 12 M 15 8 H 10 a 2 2 0 0 0 0 4 h 4 a 2 2 0 0 1 0 4 H 9' // Symmetrical Circle Dollar
    ],

    [
        'title' => 'Authorization Approvals Are Delayed',
        'desc' => 'We coordinate authorization requests, communicate with payers, track pending approvals, and reduce delays in equipment delivery and patient care.',
        'icon' => 'M 21 2 l -10 10 M 21 2 v 6 M 21 2 h -6 M 11 12 a 5 5 0 1 0 -7.07 7.07 a 5 5 0 0 0 7.07 -7.07 z' // Key (Approvals/Authorizations)
    ],

    [
        'title' => 'Operational Revenue Needs Optimization',
        'desc' => 'We analyze your DME revenue cycle, identify denial trends, uncover inefficiencies, and improve collections and payment turnaround times.',
...
<section class="max-w-6xl mx-auto px-6 py-20">
    ...
    <div class="text-center mb-16">
        ...
        <div class="inline-block px-4 py-1.5 rounded-full text-[10px] font-bold tracking-widest uppercase border mb-8 bg-[var(--secondary)] text-white border-[var(--primary)]/20">
            WHAT OUR DME BILLING TEAM HANDLES
        </div>

        <h2 class="text-4xl md:text-5xl font-bold font-gnarly text-slate-900 leading-[1.1] mb-6 capitalize">
            Every billing challenge that can slow down your<br>
            DME operations — <span class="text-[var(--primary)]">taken care of.</span>
        </h2>
        
        <p class="text-slate-500 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
            From claim denials and reimbursement delays to authorization issues and follow-ups, these are everyday challenges DME providers face. Instead of managing them internally, our DME billing specialists handle them efficiently so your team can focus on patient support.
        </p>
    </div>
...
<section class="max-w-6xl mx-auto px-6 py-12">
    ...
    <div class="w-full rounded-[40px] p-8 md:p-16 text-center" 
        ...
        <p class="text-[13px] md:text-[14px] leading-relaxed max-w-2xl mx-auto mb-10 text-white">
            Your dedicated billing team is your single point of contact for anything, claim submissions, denial management, or reimbursement guidance. Reach out anytime.
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto mb-10 text-left">
            ...
            <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/40 shadow-sm transition-transform hover:scale-[1.02] duration-300">
                <p class="text-[13px] md:text-[14px] font-medium leading-relaxed text-black">
                    Need help improving reimbursement accuracy? Our billing specialists identify denial causes and implement corrective solutions.
                </p>
            </div>
            ...
            <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/40 shadow-sm transition-transform hover:scale-[1.02] duration-300">
                <p class="text-[13px] md:text-[14px] font-medium leading-relaxed text-black">
                    Expanding your DME operations? Our team scales billing support and administrative coordination with your growth.
                </p>
            </div>
