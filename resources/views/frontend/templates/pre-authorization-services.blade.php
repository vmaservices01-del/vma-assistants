...
<section id="hero-section" class="relative w-full min-h-screen flex items-center justify-center bg-[#0a1931] py-20 px-6 overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <h1 class="text-2xl md:text-3xl lg:text-5xl max-w-2xl  mx-auto font-extrabold text-white leading-[1.1] tracking-tight mb-8 text-balance">  
             Hire Remote Pre-Authorization Support <br class="hidden md:block"> 
...
<section class="py-20 bg-gray-50">
    <div class="max-w-6xl mx-auto px-6">
        <div class="text-center max-w-4xl mx-auto mb-16">
            ...
            <h2 class="text-[26px] md:text-[36px] font-extrabold text-slate-900 mb-4 tracking-tight">How Pre-Authorization Support Works for Your Practice</h2>
            ...
            @php
                $fees = [
                    ...
                    [
                        ...
                        'desc' => ' Skilled professionals handling end-to-end insurance approval workflows',
                        'badge' => 'Included'
                    ],

                    [
                        'title' => 'Faster Approval Turnaround',
                        'icon' => 'M 23 6 H 17 M 23 6 v 6 M 23 6 L 13.5 15.5 L 8.5 10.5 L 1 18', // Accelerated trend (upward arrow)
                        'desc' => 'Optimized processes that reduce waiting time for payer decisions.',
                        'badge' => 'Included'
                    ],
                    ...
                    [
                        ...
                        'desc' => ' HIPAA-aligned handling of all patient and insurance documentation.',
                        'badge' => 'Included'
                    ],
                    ...
                    [
                        ...
                        'icon' => 'M 12 22 a 10 10 0 1 0 0 -20 a 10 10 0 0 0 0 20 z M 12 6 v 6 l 4 2', // Tracking Clock
                        'desc' => ' Continuous monitoring of authorization requests until final approval.',
                        'badge' => 'Included'
                    ],
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-20">
            <h2 class="text-[#111827]  text-[26px] md:text-[36px] font-[900] leading-[1.1] tracking-[-0.04em] mb-6">
                Why Choose VMA Pre-Authorization Services
            </h2>
            ...
            @php
                $features = [
                    ...
                    [
                        ...
                        'desc' => 'Specialized teams trained to manage insurance authorization requirements across multiple specialties.'
                    ],

                    [
                        'title' => 'Reduced Administrative Burden',
                        'desc' => 'Free your clinical staff from time-consuming approval paperwork and follow-ups.'
                    ],

                    [
                        'title' => 'HIPAA-Compliant Operations',
                        'desc' => 'Secure handling of patient records and insurance documentation under strict compliance frameworks.'
                    ],

                    [
                        'title' => 'Faster Insurance Approvals',
                        'desc' => 'Streamlined workflows that improve turnaround time for authorization decisions.'
                    ],

                    [
                        'title' => 'Flexible Support Model',
                        'desc' => 'Scale authorization assistance based on patient volume and specialty demand.'
                    ],

                    [
                        'title' => 'No Upfront Commitment',
                        'desc' => 'Begin without risk , payment only after successful onboarding and satisfaction.'
                    ],
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <h2 class="text-white text-[42px] md:text-[46px] font-extrabold leading-[1.1] tracking-[-0.03em] mb-6">
           Build Your Remote Pre-Authorization Team <br>
            is <span class="bg-gradient-to-r from-[#000] via-[#000] to-[#000] bg-clip-text text-transparent">in Just 5 Days </span>
        </h2>

        <!-- Subheading -->
        <p class="text-white/80 text-[13px] md:text-[16px] leading-relaxed max-w-2xl mx-auto mb-8 font-normal">
            Book a short demo to see how our virtual prior authorization assistant improves approval speed. <br>
