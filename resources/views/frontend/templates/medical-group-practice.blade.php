    ...
    <div class="max-w-6xl mx-auto px-6 lg:px-8 w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex flex-col justify-center">
            ...
            <div class="inline-flex items-center gap-2 px-4 py-1.5 bg-[#f0fdf4] text-[#059669] rounded-full text-xs font-semibold border border-[#dcfce7] mb-6 w-fit">
                ...
                14+ healthcare groups partnered with VMA medical group billing team
            </div>

            <!-- Heading -->
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.05] tracking-tight text-[#0F172A] mb-6 font-gnarly capitalize">
                Let medical groups focus on
                <span class="text-[#7C3AED]">coordinated patient care.</span>
            </h1>

            <!-- Description -->
            <p class="text-slate-500 text-[16px] leading-relaxed mb-8 max-w-lg font-sans">
                VMA handles multi-provider claims processing, group denial management,
                coding standardization, and reimbursement optimization so your medical
                group can focus on delivering integrated patient care.
            </p>

            <!-- Buttons -->
            <div class="flex flex-col sm:flex-row gap-3 mb-10">
                <button class="bg-primary transition-all duration-300 hover:opacity-80 text-white font-bold py-3.5 px-6 rounded-lg shadow-md">
                    Get Started Today
                </button>
                <button class="bg-white border border-gray-200 hover:bg-gray-50 text-gray-900 font-bold py-3.5 px-6 rounded-lg transition-all">
                    Learn More
                </button>
            </div>
...
<section class="max-w-6xl mx-auto px-6 py-20 text-center">
    ...
    <div class="inline-flex px-3 py-1 mb-6 text-[11px] font-bold text-primary uppercase tracking-widest bg-indigo-50/50 rounded-full border border-indigo-100">
        Medical Group Practice Billing Solutions For Multi-Provider Teams
    </div>

    <!-- Title -->
    <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tighter mb-4 capitalize">
        Smart Billing Support For Medical Group Practices
    </h2>

    <!-- Description -->
    <p class="text-gray-500 mb-10 max-w-2xl mx-auto leading-relaxed">
        VMA medical group billing experts streamline multi-provider claims processing,
        insurance verification, prior authorizations, and centralized reimbursement
        workflows to improve operational efficiency and revenue performance across
        the entire group.
    </p>

    <!-- CTA -->
    <button class="mb-16 border-2 border-gray-200 hover:border-gray-300 px-6 py-3 rounded-xl font-semibold transition-all">
        Explore Medical Group Billing Services →
    </button>
    ...
    <div class="grid md:grid-cols-3 gap-6 text-left">
        @php
            $roles = [
                [
                    'title' => 'Group Specialist',
                    'desc' => 'Maintains standardized patient records across providers while supporting compliant group workflows.',
                    'url' => '#',
                    'icon' => 'M 16 4 h 2 a 2 2 0 0 1 2 2 v 14 a 2 2 0 0 1 -2 2 H 6 a 2 2 0 0 1 -2 -2 V 6 a 2 2 0 0 1 2 -2 h 2 M 9 5 a 2 2 0 0 1 2 -2 h 2 a 2 2 0 0 1 2 2 M 8 11 h 8 M 8 15 h 5' // Group/Standardized Clipboard Checklist
                ],
                [
                    'title' => 'Practice Coordinator',
                    'desc' => 'Supports scheduling, coordination, and daily administrative operations across multiple physicians.',
                    'url' => '#',
                    'icon' => 'M 8 2 v 4 M 16 2 v 4 M 3 10 h 18 M 5 4 h 14 a 2 2 0 0 1 2 2 v 14 a 2 2 0 0 1 -2 2 H 5 a 2 2 0 0 1 -2 -2 V 6 a 2 2 0 0 1 2 -2 z M 9 16 l 2 2 4 -4' // Multi-physician calendar coordinator
                ],
                [
                    'title' => 'Multi-Provider Scribe',
                    'desc' => 'Records patient visits and updates documentation during virtual or in-person consultations for all providers.',
                    'url' => '#',
                    'icon' => 'M 12 20 h 9 M 16.5 3.5 a 2.121 2.121 0 0 1 3 3 L 7 19 l -4 1 l 1 -4 L 16.5 3.5 z' // Document with edit pen
                ],
                [
                    'title' => 'Revenue Manager',
                    'desc' => 'Oversees group billing workflows and ensures accurate reimbursement processing across all providers.',
                    'url' => '#',
                    'icon' => 'M 12 22 a 10 10 0 1 0 0 -20 a 10 10 0 0 0 0 20 z M 12 6 v 12 M 15 8 H 10 a 2 2 0 0 0 0 4 h 4 a 2 2 0 0 1 0 4 H 9' // Perfect centered circle dollar sign
                ],
                [
                    'title' => 'EMR Assistant',
                    'desc' => 'Updates and manages electronic medical records across the entire medical group with accuracy and efficiency.',
                    'url' => '#',
                ...
                [
                    ...
                    'desc' => 'Manages billing information, coding consistency, and insurance-related documentation across the practice group.',
                    'url' => '#',
                    'icon' => 'M 21 4 H 3 a 2 2 0 0 0 -2 2 v 12 a 2 2 0 0 0 2 2 h 18 a 2 2 0 0 0 2 -2 V 6 a 2 2 0 0 0 -2 -2 z M 1 10 h 22 M 4 15 h 2 M 8 15 h 4' // Standard clean insurance/eligibility ID Card
                ]
            ];
        @endphp
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-16">
            ...
            <h2 class="text-[#111827] text-[26px] md:text-[36px] font-[900] leading-[1.1] tracking-[-0.04em] mb-6">
                Certified in the EHR Your Medical Group Already Uses
            </h2>

            <p class="text-black text-[14px] md:text-[16px] leading-relaxed max-w-3xl mx-auto font-normal">
                Stop wasting time on software training. VMA's 4-week intensive training program provides
                vetted and certified professionals skilled in multi-provider documentation workflows and
                complex group billing cycles. We ensure seamless integration so your medical group never misses a beat.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @php
                $ehrList = [
                    [
                        'title' => 'Epic',
                        'desc' => 'Charting, Order Entry, InBasket, Haiku across providers.',
                        'icon' => 'building'
                    ],
                    [
                        'title' => 'athenahealth',
                        'desc' => 'Workflows, Collections, Patient Communications for group practices.',
                        'icon' => 'building'
                    ],
                    [
                        'title' => 'eClinicalWorks',
                        'desc' => 'Scheduling, Billing, Portal Management across multiple physicians.',
                        'icon' => 'building'
                    ],
                    [
                        'title' => 'CareCloud',
                        'desc' => 'RCM, Telehealth, Practice Management for medical groups.',
                        'icon' => 'building'
                    ],
                    [
                        'title' => 'Tebra (Kareo)',
                        'desc' => 'Billing, Engagement, Patient Scheduling across providers.',
                        'icon' => 'building'
                    ],
                    [
                        'title' => 'RingCentral',
                        'desc' => 'VOIP, Communications, Call Routing for group coordination.',
                        'icon' => 'phone'
                    ],
                    [
                        'title' => 'Availity / NaviNet',
                        'desc' => 'Eligibility, Authorizations, Claims Processing for multi-provider billing.',
                        'icon' => 'lock'
                    ],
                    [
                        'title' => 'Phreesia',
                        'desc' => 'Intake, Digital Payments, Patient Analytics for group practices.',
                        'icon' => 'chart'
                    ],
                ];
            @endphp
...
<section class="max-w-6xl mx-auto py-20 bg-white">
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-12 animate-fade-in">
            ...
            <p class="text-slate-500 text-md max-w-3xl mx-auto leading-relaxed">
                VMA provides complete affordable medical group practice billing support services designed to help multi-provider healthcare organizations improve operational efficiency with reliable infrastructure and trained professionals.
            </p>
        </div>
            ...
            @php
                $fees = [                    
                    [
                        ...
                        'desc' => 'Structured workflows to ensure consistent delivery and operational efficiency across providers.',
                    ...
                    [
                        ...
                        'desc' => 'HIPAA-ready processes for secure multi-provider billing and administrative operations.',
                    ...
                    [
                        'title' => 'Physician Group Coordination',
                        'desc' => 'Simple agreements and ongoing support for smooth medical group billing operations.',
                        'icon' => 'M 17 21 v -2 a 4 4 0 0 0 -4 -4 H 5 a 4 4 0 0 0 -4 4 v 2 M 9 11 a 4 4 0 1 0 0 -8 a 4 4 0 1 0 0 8 M 23 21 v -2 a 4 4 0 0 0 -3 -3.87 M 16 3.13 a 4 4 0 0 1 0 7.75' // Multi-provider Users
                    ],
                    [
                        'title' => 'Insurance Eligibility Management',
                        'desc' => 'Accurate and timely claims submissions across all providers to ensure faster reimbursements.',
                        'icon' => 'M 12 22 s 8 -4 8 -10 V 5 l -8 -3 -8 3 v 7 c 0 6 8 10 8 10 z M 9 11 l 2 2 4 -4' // Shield Check
                    ],
                    [
                        'title' => 'Multi-Provider Support',
                        'desc' => 'Fully managed onboarding for your dedicated medical group billing support team.',
                    ...
                    [
                        ...
                        'desc' => 'Efficient eligibility checks and coverage verification for smooth group billing operations.',
                        'icon' => 'M 14 2 H 6 a 2 2 0 0 0 -2 2 v 16 a 2 2 0 0 0 2 2 h 12 a 2 2 0 0 0 2 -2 V 8 z M 14 2 v 6 h 6 M 8 12 h 8 M 8 16 h 5' // Structured Document / Invoice Sheet
                    ],
                    [
                        'title' => 'Revenue Optimization',
                        'desc' => 'Proactive claim tracking, denial resolution, and payment follow-ups to maximize group revenue.',
                        'icon' => 'M 12 22 a 10 10 0 1 0 0 -20 a 10 10 0 0 0 0 20 z M 12 6 v 12 M 15 8 H 10 a 2 2 0 0 0 0 4 h 4 a 2 2 0 0 1 0 4 H 9' // Symmetric Circle Dollar
                    ],
                    [
                        'title' => 'Financial Reporting',
                        'desc' => 'HIPAA-compliant billing processes with detailed financial reporting and transparency across providers.',
                        'icon' => 'M 18 20 V 10 M 12 20 V 4 M 6 20 v -6 M 3 20 h 18' // Clean Bar Chart
                    ]
                ];
            @endphp
            @foreach($fees as $fee)
...
<section class="max-w-6xl mx-auto px-6 py-12">
    @php
        $customerBenefits = [
            'Improves group-wide claim accuracy & reimbursement rates',
            'Reduces billing errors across multiple providers',
            'Streamlines multi-provider revenue cycle operations',
            'Provides centralized reporting & financial insights',
            'Supports payer communication for all physicians',
        ];

        $talentBenefits = [
            'Speeds up insurance verification across providers',
            'Ensures smoother billing workflows for all patients',
            'Helps resolve claim and payment issues quickly',
            'Maintains HIPAA-compliant group billing processes',
            'Delivers consistent ongoing billing support & follow-ups',
        ];
    @endphp
    ...
    <div class="relative w-full rounded-[40px] overflow-hidden p-8 md:p-12 lg:p-18 bg-gradient-to-br from-[#0d8276] via-[#115e59] to-[#4c1d95] text-white">
        ...
        <div class="relative z-10">
            ...
            <div class="inline-block px-4 py-1.5 rounded-full border border-white/30 text-[10px] font-bold tracking-widest uppercase mb-10">
               Medical Group Billing Bridge
            </div>

            <!-- Heading -->
            <h2 class="text-3xl md:text-4xl font-bold font-gnarly leading-[1.1] mb-6 max-w-4xl capitalize">
            ...
            <p class="text-white/70 text-[14px] max-w-3xl leading-relaxed mb-10 font-sans">
                Our Medical Group Billing Service account manager isn't just your billing contact.
                They serve as the single point of contact for both your medical group and our billing team,
                acting as a bridge between all providers and operations. When there's a concern, they already
                have context from multiple perspectives. When there's a discrepancy, they resolve it.
                When there's an opportunity, they coordinate and optimize the entire group revenue cycle.
            </p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                <div class="lg:col-span-5">
                    <h3 class="text-white/50 text-[14px] font-bold tracking-widest uppercase mb-6">For Your Medical Group Practice</h3>
                    <ul class="space-y-2">
...
@php
    $challenges = [
        [
            'title' => 'Group Reimbursement Issues Are Increasing',
            'desc' => 'Our medical group billing specialists investigate denial patterns across providers, identify recurring issues, and implement corrective actions to improve first-pass reimbursement rates.',
            'icon' => '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 17h8m-8-5h8m-8-5h8M3 6l4 12 4-12m1-1l-5 14"/></svg>'
        ],
        [
            'title' => 'Multi-Provider Coverage Verification Delays',
            'desc' => 'Coverage discrepancies across patients and providers can delay payments. Our team verifies benefits, confirms coverage details, and resolves billing obstacles before submission.',
        ...
        [
            'title' => 'Your Medical Group Is Expanding',
            'desc' => 'As your group expands, billing complexity increases across providers. We manage higher claim volumes, standardize workflows, and ensure revenue cycles scale efficiently.',
        ...
        [
            'title' => 'Administrative Load Across Providers Is Growing',
            'desc' => 'Whether it\'s new payer requirements, group billing regulations, or system updates, our specialists ensure consistent accuracy and compliance across all providers.',
            'icon' => '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"/></svg>'
        ],
        [
            'title' => 'Outstanding Group Receivables Are Rising',
            'desc' => 'Unpaid claims across providers can significantly impact cash flow. Our team follows up on aging accounts, appeals denials, and accelerates reimbursements group-wide.',
        ...
        [
            'title' => 'Group Revenue Recovery Needs Improvement',
            'desc' => 'We identify underpayments, missed reimbursements, and billing errors across providers, helping recover revenue that might otherwise remain uncollected.',
        ...
        [
            'title' => 'Prior Authorization Bottlenecks',
            'desc' => 'Treatment approvals across multiple providers can delay care and reimbursement. We coordinate prior authorizations and minimize delays across the group.',
            'icon' => '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 21h6l-.75-4M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>'
        ],
        [
            'title' => 'Your Group Revenue Performance Is Unclear',
            'desc' => 'Our specialists analyze your entire group revenue cycle, uncover inefficiencies, and provide actionable insights to improve collections and reduce denials.',
...
<section class="max-w-6xl mx-auto px-6 py-20">
    ...
    <div class="text-center mb-16">
        ...
        <div class="inline-block px-4 py-1.5 rounded-full text-[10px] font-bold tracking-widest uppercase border mb-8 bg-[var(--secondary)] text-white border-[var(--primary)]/20">
            What Our Medical Group Billing Team Handles
        </div>

        <h2 class="text-4xl md:text-5xl font-bold font-gnarly text-slate-900 leading-[1.1] mb-6 capitalize">
            Every billing challenge that can slow down your medical group operations —
            <span class="text-[var(--primary)]">taken care of.</span>
        </h2>

        <p class="text-slate-500 text-sm md:text-base max-w-3xl mx-auto leading-relaxed">
            From multi-provider claim rejections and payment delays to prior authorization bottlenecks and revenue recovery, these are everyday challenges medical groups face. Instead of managing them across departments, our billing specialists handle them centrally so your group can focus on patient care.
        </p>
    </div>
...
<section class="max-w-6xl mx-auto px-6 py-12">
    ...
    <div class="w-full rounded-[40px] p-8 md:p-16 text-center" 
        ...
        <p class="text-[13px] md:text-[14px] leading-relaxed max-w-3xl mx-auto mb-10 text-white">
            Your dedicated billing team is your single point of contact for everything — claims, denials, prior authorizations, reimbursement issues, and revenue cycle support across your entire medical group. Reach out anytime.
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto mb-10 text-left">
            ...
            <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/40 shadow-sm transition-transform hover:scale-[1.02] duration-300">
                <p class="text-[13px] md:text-[14px] font-medium leading-relaxed text-black">
                    Need help improving group reimbursement performance? Our specialists identify root causes, reduce denials, and implement corrective solutions to improve collections.
                </p>
            </div>
            ...
            <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/40 shadow-sm transition-transform hover:scale-[1.02] duration-300">
                <p class="text-[13px] md:text-[14px] font-medium leading-relaxed text-black">
                    Expanding your medical group practice? Our team scales billing, insurance verification, and administrative support across all providers.
                </p>
            </div>
...
<section class="py-24 px-6 bg-primary antialiased text-center">
    <div class="max-w-4xl mx-auto">
        ...
        <h2 class="text-white text-[42px] md:text-[46px] font-extrabold leading-[1.1] tracking-[-0.03em] mb-6 capitalize">
            Meet your next billing specialist<br>
            in <span class="bg-gradient-to-r from-black via-black to-black bg-clip-text text-transparent">just 7 days</span>
        </h2>

        <!-- Subheading -->
        <p class="text-white/80 text-[13px] md:text-[16px] leading-relaxed max-w-2xl mx-auto mb-8 font-normal">
            Book a demo to see matched, pre-vetted medical billing professionals ready to support your medical group practice.
        ...
        <div class="mb-6">
            <a href="#"
            class="inline-flex items-center gap-2 bg-white text-black px-8 py-4 rounded-xl font-bold text-[17px] transition-transform hover:scale-105">
                Request a Demo
