...
<section id="hero-section" class="relative w-full min-h-screen flex items-center justify-center bg-[#0a1931] py-20 px-6 overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <p class="max-w-2xl mx-auto text-lg text-slate-300 mb-12 text-[16px]">
            Reduce administrative burden and prevent claim rejections with reliable eligibility and benefits verification tailored for modern healthcare practices.
        </p>
        ...
        <div class="mt-16 max-w-4xl mx-auto">
            <div class="flex flex-wrap items-center justify-center gap-x-10 gap-y-4 mb-6">
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    <span class="text-sm font-medium text-slate-300 tracking-wide">Fast, accurate, and scalable support</span>
                </div>
                <div class="hidden md:block w-px h-4 bg-white/10"></div>
                <div class="flex items-center gap-2.5">
                    <div class="flex-shrink-0 w-5 h-5 rounded-full bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20">
    ...
    <div class="max-w-6xl mx-auto px-6 space-y-32">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div class="lg:col-span-7 order-2 lg:order-1">
                <h2 class="text-[26px] md:text-[36px] font-extrabold text-slate-900 mb-8 tracking-tight leading-[1.15] text-balance">
                    Reduce Denials.  <span class="text-[var(--primary)]">Improve Cash Flow. </span>
                </h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div class="lg:col-span-7 order-2 lg:order-2">
                <h2 class="text-[26px] md:text-[36px] font-extrabold text-slate-900 mb-8 tracking-tight leading-[1.15] text-balance">
                    Secure Verification. <span class="text-[var(--primary)]">Protected at Every Step.</span>
                </h2>
                <div class="space-y-6 max-w-2xl">
                    <p class="text-slate-500 text-[16px] leading-relaxed">
                        Patient trust starts with data security. Our HIPAA compliant eligibility verification company ensures every insurance check is handled with strict confidentiality and regulatory compliance.
                    </p>
                    <p class="text-slate-500 text-[16px] leading-relaxed ">
                        From insurance eligibility verification for healthcare providers to detailed benefits breakdowns, we keep your front desk and billing teams fully supported while protecting patient privacy.
                    </p>
                </div>
            </div>
        </div>
...
<section class="py-20 px-6 bg-white antialiased">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-20">
            <h2 class="text-[#111827]  text-[26px] md:text-[36px] font-[900] leading-[1.1] tracking-[-0.04em] mb-6">
               Why Choose VMA Eligibility Verification Services
            </h2>
            ...
            @php
                $features = [
                    [
                        ...
                        'desc' => 'Specialized teams trained in medical insurance eligibility and benefits verification workflows.'
                    ],
                    [
                        'title' => 'Cost-Efficient Operations',
                        'desc' => 'Reduce administrative costs by up to 60% with outsourced insurance eligibility verification services.'
                    ],
                    [
                        'title' => 'HIPAA-Compliant Processes',
                        'desc' => 'Secure, regulated workflows aligned with HIPAA, SOC 2 Type II, ISO 27001, and GDPR standards.'
                    ],
                    [
                        'title' => 'Faster Patient Intake',
                        'desc' => 'Real-time eligibility verification reduces waiting time and improves patient experience.'
                    ],
                    [
                        'title' => 'Flexible Outsourcing Model',
                        'desc' => 'Scale verification support up or down based on patient volume and practice needs.'
                    ],
                    [
                        'title' => 'No Upfront Commitment',
                        'desc' => 'Start without risk—pay only when you’re satisfied with the service.'
                    ]
                ];
            @endphp
            ...
            <div class="lg:col-span-7">
                <div class="max-w-xl">
                    ...
                    <p class="text-slate-500 text-[16px] mb-10">
                       Let’s discuss your practice needs and how our eligibility and benefits verification services can improve your revenue cycle and patient intake process.
                    </p>
                    ...
                    <form action="{{ route('backend.discovery.submit') }}" method="POST" class="space-y-4">
                        ...
                        <p class="text-[11px] leading-relaxed text-slate-400 mt-6">
                            By submitting this form, you agree to our Privacy Policy and consent to receive emails and text messages. You may unsubscribe anytime.
                        </p>
...
<section class="py-20 px-6 bg-primary antialiased text-center">
    <div class="max-w-4xl mx-auto">
        ...
        <!-- Subheading -->
        <p class="text-white/80 text-[15px] md:text-[16px] leading-relaxed max-w-2xl mx-auto mb-8 font-normal">
            Book a quick demo to see how our experts streamline your front desk and billing operations.
            <br class="hidden md:block">
            No delays. No long-term contracts. No hidden costs.
        </p>
        ...
        <div class="flex flex-wrap justify-center items-center gap-x-6 gap-y-4">
            ...
            @foreach($benefits as $benefit)
                <div class="flex items-center gap-2 text-white font-medium text-[14px]">
