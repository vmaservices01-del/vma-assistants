        ...
        <nav class="hidden lg:flex items-center gap-2">
            ...
            <div class="relative" @mouseleave="openMenu = null">
                ...
                <div x-show="openMenu === 'Our Expertise'" 
                     x-cloak 
                     class="absolute left-0 top-full mt-0 w-[340px] bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-gray-100 p-3 z-50 space-y-1" style="width: 340px;">
