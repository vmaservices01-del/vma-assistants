        ...
        <nav class="hidden lg:flex items-center gap-2">
            ...
            <div class="relative" @mouseleave="openMenu = null">
                <button @mouseenter="openMenu = 'Our Expertise'" 
                    ...
                    Our Expertise <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"></path></svg>
                </button>

                <!-- Vertical Dropdown -->
                <div x-show="openMenu === 'Our Expertise'" x-cloak class="absolute left-0 top-full mt-0 w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 p-2 z-50">
                    <a href="{{ url('dental-billing') }}" class="flex items-start gap-4 p-3 rounded-xl hover:bg-gray-50 transition">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Claims, verifications & collections</p>
                        </div>
                    </a>

                    <a href="{{ url('dme-billing-service') }}" class="flex items-start gap-4 p-3 rounded-xl hover:bg-gray-50 transition">
                        <div class="w-10 h-10 flex items-center justify-center bg-gray-50 rounded-lg text-lg border">
                            <svg class="w-5 h-5 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">DME claims & equipment billing</p>
                        </div>
                    </a>

                    <a href="{{ url('hospital-billing-service') }}" class="flex items-start gap-4 p-3 rounded-xl hover:bg-gray-50 transition">
                        <div class="w-10 h-10 flex items-center justify-center bg-gray-50 rounded-lg text-lg border">
                            <svg class="w-5 h-5 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Inpatient & outpatient RCM</p>
                        </div>
                    </a>

                    <a href="{{ url('medical-group-practice') }}" class="flex items-start gap-4 p-3 rounded-xl hover:bg-gray-50 transition">
                        <div class="w-10 h-10 flex items-center justify-center bg-gray-50 rounded-lg text-lg border">
                            <svg class="w-5 h-5 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Multi-specialty billing solutions</p>
                        </div>
                    </a>

                    <a href="{{ url('physician-billing-service') }}" class="flex items-start gap-4 p-3 rounded-xl hover:bg-gray-50 transition">
                        <div class="w-10 h-10 flex items-center justify-center bg-gray-50 rounded-lg text-lg border">
                            <svg class="w-5 h-5 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Solo & practice revenue management</p>
                        </div>
                    </a>
                    ...
                    <a href="{{ url('urgent-care') }}" class="flex items-start gap-4 p-3 rounded-xl hover:bg-gray-50 transition">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Fast acute care billing workflow</p>
                        </div>
                    </a>
                </div>
            </div>
